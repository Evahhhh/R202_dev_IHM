...
public class Evaluation implements Serializable{
    ...
    public void lectureEvaluation(String fichier, ObjectInputStream in) throws IOException{
        try {
    ...
    public void ecritureEvaluation(ObjectOutputStream out) throws IOException{           
